    ...
    <div>
        <v-layout>
            <v-flex
                    sm
            >
                <v-layout v-if="filterType != 0x04" row>
                    <v-flex>
        ...
        methods:{
            addFilter(){
                ...
                if( this.filterType != 0x04){
                    filter = {
                        hexId: this.hexId,
                        propertyModificationType: this.isAdd?PropertyModificationType.Add:PropertyModificationType.Remove
                    }
                }else {
                    filter = {
            ...
            generateAddressTransaction(){
                const {maxFee,actionType,filterType,filterList} = this
